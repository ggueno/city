...
void mat4fInverse(const float * __restrict__ matA, float * __restrict__ matB)
{
	...
	matB[1] =  -matA[4]*matA[10]*matA[15] + matA[4]*matA[11]*matA[14] + matA[8]*matA[6]*matA[15]
		- matA[8]*matA[7]*matA[14] - matA[12]*matA[6]*matA[11] + matA[12]*matA[7]*matA[10];
	matB[2] =	matA[4]*matA[9]*matA[15] - matA[4]*matA[11]*matA[13] - matA[8]*matA[5]*matA[15]
		+ matA[8]*matA[7]*matA[13] + matA[12]*matA[5]*matA[11] - matA[12]*matA[7]*matA[9];
	matB[3] = -matA[4]*matA[9]*matA[14] + matA[4]*matA[10]*matA[13] + matA[8]*matA[5]*matA[14]
		- matA[8]*matA[6]*matA[13] - matA[12]*matA[5]*matA[10] + matA[12]*matA[6]*matA[9];
	matB[4] =  -matA[1]*matA[10]*matA[15] + matA[1]*matA[11]*matA[14] + matA[9]*matA[2]*matA[15]
	...
	matB[6] =  -matA[0]*matA[9]*matA[15] + matA[0]*matA[11]*matA[13] + matA[8]*matA[1]*matA[15]
		- matA[8]*matA[3]*matA[13] - matA[12]*matA[1]*matA[11] + matA[12]*matA[3]*matA[9];
	matB[7] =	matA[0]*matA[9]*matA[14] - matA[0]*matA[10]*matA[13] - matA[8]*matA[1]*matA[14]
		+ matA[8]*matA[2]*matA[13] + matA[12]*matA[1]*matA[10] - matA[12]*matA[2]*matA[9];
	matB[8] =	matA[1]*matA[6]*matA[15] - matA[1]*matA[7]*matA[14] - matA[5]*matA[2]*matA[15]
		+ matA[5]*matA[3]*matA[14] + matA[13]*matA[2]*matA[7] - matA[13]*matA[3]*matA[6];
	matB[9] =  -matA[0]*matA[6]*matA[15] + matA[0]*matA[7]*matA[14] + matA[4]*matA[2]*matA[15]
	...
	matB[11] = -matA[0]*matA[5]*matA[14] + matA[0]*matA[6]*matA[13] + matA[4]*matA[1]*matA[14]
		- matA[4]*matA[2]*matA[13] - matA[12]*matA[1]*matA[6] + matA[12]*matA[2]*matA[5];
	matB[12] =  -matA[1]*matA[6]*matA[11] + matA[1]*matA[7]*matA[10] + matA[5]*matA[2]*matA[11]
		- matA[5]*matA[3]*matA[10] - matA[9]*matA[2]*matA[7] + matA[9]*matA[3]*matA[6];
	matB[13] =	matA[0]*matA[6]*matA[11] - matA[0]*matA[7]*matA[10] - matA[4]*matA[2]*matA[11]
		+ matA[4]*matA[3]*matA[10] + matA[8]*matA[2]*matA[7] - matA[8]*matA[3]*matA[6];
	matB[14] = -matA[0]*matA[5]*matA[11] + matA[0]*matA[7]*matA[9] + matA[4]*matA[1]*matA[11]
